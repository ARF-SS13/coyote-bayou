...
/datum/interaction/lewd/partner/recieving/sniff_crotch
	description = "Partner/Head - Sniff their crotch."
	interaction_sound = null
	max_distance = 1
...
/datum/interaction/lewd/partner/giving/grab_balls
	description = "Partner/Body - Grab their balls."
	require_user_hands = TRUE
	interaction_sound = null
	max_distance = 1
...
/datum/interaction/lewd/partner/mutual/tease_kitty
	description = "Partner/Body - Tease their pussy with your cock."
	interaction_sound = null
	max_distance = 1
...
/datum/interaction/lewd/partner/mutual/tease_eggplant
	description = "Partner/Body - Tease their cock with your pussy."
	interaction_sound = null
	max_distance = 1
...
/datum/interaction/lewd/partner/giving/spank_ass
	description = "Partner/Body - Spank their behind."
	require_user_hands = TRUE
	interaction_sound = null
	max_distance = 1
...
/datum/interaction/lewd/partner/giving/lick_thigh
	description = "Partner/Body - Lick their thighs."
	require_user_hands = TRUE
	interaction_sound = null
	max_distance = 1
...
/datum/interaction/lewd/partner/giving/grab_thigh
	description = "Partner/Body - Grab their thighs."
	require_user_hands = TRUE
	interaction_sound = null
	max_distance = 1
...
/datum/interaction/lewd/partner/mutual/bite_thigh
	description = "Partner/Body - Bite their thigh."
	interaction_sound = null
	max_distance = 1
...
/datum/interaction/lewd/partner/mutual/rest_thigh
	description = "Partner/Body - Rest your head on their thigh."
	interaction_sound = null
	max_distance = 1
