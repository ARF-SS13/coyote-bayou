...
/obj/structure/flora/wasteplant/berrybush/tinto
...
/obj/item/reagent_containers/food/snacks/grown/berries/tinto
	name = "tinto berries"
	icon_state = "tintoberry"
	icon = 'modular_coyote/icons/objects/berries.dmi'

/obj/item/reagent_containers/food/snacks/grown/berries/azul
	name = "azul berries"
	icon_state = "azulberry"
	icon = 'modular_coyote/icons/objects/berries.dmi'

/obj/item/reagent_containers/food/snacks/grown/berries/amar
	name = "amar berries"
	icon_state = "amarberry"
	icon = 'modular_coyote/icons/objects/berries.dmi'

/obj/item/reagent_containers/food/snacks/grown/berries/majo
	name = "majo berries"
	icon_state = "majoberry"
	icon = 'modular_coyote/icons/objects/berries.dmi'

/obj/item/reagent_containers/food/snacks/grown/berries/narco
	name = "narco berries"
	icon_state = "narcoberry"
	icon = 'modular_coyote/icons/objects/berries.dmi'

/obj/item/reagent_containers/food/snacks/grown/berries/zelenyy
