...
/datum/gear/hands/diamond_ring
	...
	cost = 0 //swapped the plasma/diamond ring around. Should go Plasma > Diamond > bluespace anyhow.

/datum/gear/hands/bluespace_ring
	name = "Bluespace Ring"
	path = /obj/item/clothing/gloves/ring/bluespace
	cost = 0 //as with the diamond ring, but larger. Hence the higher cost comparitavely.
