...
/datum/chemical_reaction/fermi/enthrall //check this
	...
	required_reagents = list(/datum/reagent/consumable/coco = 1, /datum/reagent/drug/jet = 1, /datum/reagent/toxin/mindbreaker = 1, /datum/reagent/medicine/psicodine = 1, /datum/reagent/drug/happiness = 1)
