            ...
            <Section
              ...
              <Flex direction="row">
                ...
                <Flex.Item grow={1} basis={0}>
                  <QuirkJizz QuirksInCat={FilteredAllFlirts} />
                </Flex.Item>
              </Flex>
            </Section>
          </Stack.Item>
...
const QuirkJizz = (props, context) => {
  ...
  const ShowQuirks = FilteredAllFlirts.slice(ShowRange[0], ShowRange[1]);
...
// / It takes a quirk key, and retrieves from AllFlirts the quirk object
...
const QuirkKey2Obj = (QuirkKey, context) => {
  ...
  const QuirkObject = AllFlirts.find(Quirk => Quirk.Qkey === QuirkKey);
  return QuirkObject || {
    'Qkey': 'Oh. Ohhhhh no.',
    'Qname': 'Oh no.',
