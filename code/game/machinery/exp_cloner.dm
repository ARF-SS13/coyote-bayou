...
/obj/machinery/clonepod/experimental
	name = "cloning pod"
	desc = "A miraculous piece of Pre-Fall tech that seems to be able to return life to the dead. Whether or not it works as intended is something else entirely."
