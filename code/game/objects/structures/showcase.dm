...
/obj/structure/showcase/mecha/marauder
	...
	desc = "A stand with an empty old US Government Corporation combat mech bolted to it. It is described as the premier unit used to defend corporate interests and employees."
...
/obj/structure/showcase/machinery/implanter
	...
	desc = "A flimsy model of a standard US Government automated mindshield implant machine. With secure positioning harnesses and a robotic surgical injector, brain damage and other serious medical anomalies are now up to 60% less likely!"
...
/obj/structure/showcase/machinery/cloning_pod
	...
	desc = "Signs describe how cloning pods like these ensure that every US Government employee can carry out their contracts in full, even in the unlikely event of their catastrophic death. Hopefully they aren't all made of cardboard, like this one."
	icon = 'icons/obj/machines/cloning.dmi'
	icon_state = "pod_0"

/obj/structure/showcase/perfect_employee
	name = "'Perfect Man' employee exhibit"
	desc = "A stand with a model of the perfect US Government Employee bolted to it. Signs indicate it is robustly genetically engineered, as well as being ruthlessly loyal."

/obj/structure/showcase/machinery/tv
	name = "Nanotrasen corporate newsfeed"
	desc = "A slightly battered looking TV. Various US Government infomercials play on a loop, accompanied by a jaunty tune."
	icon = 'icons/obj/computer.dmi'
