...
/obj/effect/spawner/lootdrop/f13/trash_guns
	...
	loot = list(
		...
		/obj/item/gun/ballistic/rifle/mosin/mini = 5,
	)
...
/obj/effect/spawner/lootdrop/f13/common_guns
	...
	loot = list(
		...
		/obj/item/gun/ballistic/automatic/varmint/bushmaster_arm_gun = 7,
		/obj/item/gun/ballistic/automatic/smg/smg10mm/worn = 5,
