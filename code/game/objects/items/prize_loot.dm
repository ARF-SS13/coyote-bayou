/obj/item/lockpick_set
	...
	var/uses_left = 6 			// Might need more.  Needs Playtesting.
	var/success_chance = 20 	// 20%
	var/break_chance = 20 		// 20% (after failing a check. so yes, technically less than 15% overall.)
