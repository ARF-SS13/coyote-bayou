...
/world/proc/update_status()
	...
	s += "<b>[station_name()]</b>";
	s += " ("
	s += "<a href=\"https://discord.gg/w3NWQX6n\">" //Change this to wherever you want the hub to link to. CIT CHANGE - links to cit's website on the hub
	s += "WIP Fallout"  //Replace this with something else. Or ever better, delete it and uncomment the game version. CIT CHANGE - modifies the hub entry link
	s += "</a>"
