...
GLOBAL_LIST_INIT(firstlegion_names_male, world.file2list("strings/names/firstlegion_male.txt"))
GLOBAL_LIST_INIT(firstlegion_names_female, world.file2list("strings/names/firstlegion_female.txt"))
GLOBAL_LIST_INIT(lastlegion_names, world.file2list("strings/names/lastlegion.txt"))
