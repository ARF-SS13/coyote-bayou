GLOBAL_LIST_INIT(bitfields, list(
	...
	"genital_flags" = list(
		...
		"GENITAL_CAN_AROUSE" = GENITAL_CAN_AROUSE,
		"UPDATE_OWNER_APPEARANCE" = UPDATE_OWNER_APPEARANCE,
		"GENITAL_CAN_TAUR" = GENITAL_CAN_TAUR,
		"GENITAL_CAN_RECOLOR" = GENITAL_CAN_RECOLOR,
		"GENITAL_CAN_RESIZE" = GENITAL_CAN_RESIZE,
		"GENITAL_CAN_RESHAPE" = GENITAL_CAN_RESHAPE,
	),
	"mob_biotypes" = list (
