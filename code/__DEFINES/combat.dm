...
//Nice shot bonus
#define NICE_SHOT_RICOCHET_BONUS	30	//if the shooter has the NICE_SHOT trait and they fire a ricocheting projectile, add this to the ricochet chance and auto aim angle
