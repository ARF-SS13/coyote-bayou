...
#define GUN_FIRE_RATE_40 RPM_TO_FIRE_DELAY(80) // 40 RPM = 15 deciseconds per shot | Fenny said to double them all! - Jaeger
#define GUN_FIRE_RATE_75 RPM_TO_FIRE_DELAY(150) // 75 RPM = 8 deciseconds per shot
#define GUN_FIRE_RATE_100 RPM_TO_FIRE_DELAY(200) // 100 RPM = 6 deciseconds per shot
#define GUN_FIRE_RATE_150 RPM_TO_FIRE_DELAY(300) // 150 RPM = 4 deciseconds per shot
#define GUN_FIRE_RATE_200 RPM_TO_FIRE_DELAY(400) // 200 RPM = 3 deciseconds per shot
#define GUN_FIRE_RATE_300 RPM_TO_FIRE_DELAY(600) // 300 RPM = 2 deciseconds per shot
#define GUN_FIRE_RATE_400 RPM_TO_FIRE_DELAY(800) // 400 RPM = 1.5 deciseconds per shot
#define GUN_FIRE_RATE_600 RPM_TO_FIRE_DELAY(1200) // 600 RPM = 1 decisecond per shot
#define GUN_FIRE_RATE_800 RPM_TO_FIRE_DELAY(1600) // 800 RPM = 0.75 deciseconds per shot
#define GUN_FIRE_RATE_1000 RPM_TO_FIRE_DELAY(2000) // 1000 RPM = 0.6 deciseconds per shot
#define GUN_FIRE_RATE_1200 RPM_TO_FIRE_DELAY(2400) // 1200 RPM = 0.5 deciseconds per shot
