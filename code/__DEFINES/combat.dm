...
#define BULLET_DAMAGE_PISTOL_HEDIUM 15
#define BULLET_DAMAGE_PISTOL_HEAVY 20
#define BULLET_DAMAGE_RIFLE_LIGHT 25
#define BULLET_DAMAGE_RIFLE_HEAVY 35
...
#define BULLET_STAMINA_PISTOL_HEDIUM (BULLET_DAMAGE_PISTOL_HEDIUM * 1)
...
#define BULLET_STAMINA_RIFLE_HEAVY (BULLET_DAMAGE_RIFLE_HEAVY * 0.5)
...
#define RUBBER_DAMAGE_PISTOL_LIGHT (BULLET_DAMAGE_PISTOL_LIGHT * 2)
#define RUBBER_DAMAGE_PISTOL_HEDIUM (BULLET_DAMAGE_PISTOL_HEDIUM * 2)
#define RUBBER_DAMAGE_PISTOL_HEAVY (BULLET_DAMAGE_PISTOL_HEAVY * 2)
#define RUBBER_DAMAGE_RIFLE_LIGHT (BULLET_DAMAGE_RIFLE_LIGHT * 0.5)
#define RUBBER_DAMAGE_RIFLE_HEAVY (BULLET_DAMAGE_RIFLE_HEAVY * 2.5)
#define RUBBER_STAMINA_SHOT (BULLET_DAMAGE_SHOTGUN_PELLET)
#define RUBBER_STAMINA_BEAN (BULLET_STAMINA_SHOTGUN_SLUG * 2)
...
#define BULLET_DAMAGE_MATCH 1.5 // rare, pack a punch
#define BULLET_DAMAGE_SURPLUS 1 // standard ammo from an ammobench
#define BULLET_DAMAGE_HANDLOAD 0.5 // trash ammo you can make anywhere with a reloader tool, most common
...
#define RUBBER_WOUND_PISTOL_LIGHT (BULLET_WOUND_PISTOL_LIGHT)
#define RUBBER_WOUND_PISTOL_MEDIUM (BULLET_WOUND_PISTOL_MEDIUM * 1.5)
#define RUBBER_WOUND_PISTOL_HEAVY (BULLET_WOUND_PISTOL_HEAVY * 1.5)
#define RUBBER_WOUND_RIFLE_LIGHT (BULLET_WOUND_RIFLE_LIGHT * 1.5)
#define RUBBER_WOUND_RIFLE_HEAVY (BULLET_WOUND_RIFLE_HEAVY * 2)
#define RUBBER_WOUND_SHOTGUN_PELLET (-BULLET_WOUND_SHOTGUN_PELLET * 0.1) // cus negative
#define RUBBER_WOUND_SHOTGUN_SLUG (BULLET_WOUND_SHOTGUN_SLUG * 1.1)
...
#define BULLET_WOUND_FALLOFF_RIFLE_LIGHT 1
...
#define BULLET_NAKED_RUBBER_WOUND_MULT 0.5
...
#define BULLET_SPEED_PISTOL_LIGHT (BULLET_BASE_SPEED * 0.85)
#define BULLET_SPEED_PISTOL_HEDIUM (BULLET_BASE_SPEED * 0.90)
#define BULLET_SPEED_PISTOL_HEAVY (BULLET_BASE_SPEED * 0.90)
#define BULLET_SPEED_RIFLE_LIGHT (BULLET_BASE_SPEED * 1.2)
#define BULLET_SPEED_RIFLE_HEAVY (BULLET_BASE_SPEED * 3)
#define BULLET_SPEED_SHOTGUN_PELLET (BULLET_BASE_SPEED * 0.90)
#define BULLET_SPEED_SHOTGUN_SLUG (BULLET_BASE_SPEED * 0.85)
