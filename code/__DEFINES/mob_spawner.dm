...
/// Mob spawner times
#define MOB_SPAWNER_TIME_LONGEST (180 SECONDS)
#define MOB_SPAWNER_TIME_LONGER (60 SECONDS)
#define MOB_SPAWNER_TIME_LONG (40 SECONDS)
#define MOB_SPAWNER_TIME_DEFAULT (20 SECONDS)
#define MOB_SPAWNER_TIME_QUICK (15 SECONDS)
#define MOB_SPAWNER_TIME_QUICKER (10 SECONDS)
#define MOB_SPAWNER_TIME_QUICKEST (5 SECONDS)
