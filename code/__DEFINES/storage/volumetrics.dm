...
#define DEFAULT_VOLUME_TINY WEIGHT_CLASS_TINY
#define DEFAULT_VOLUME_SMALL WEIGHT_CLASS_SMALL
#define DEFAULT_VOLUME_NORMAL WEIGHT_CLASS_NORMAL
#define DEFAULT_VOLUME_BULKY WEIGHT_CLASS_BULKY
#define DEFAULT_VOLUME_HUGE WEIGHT_CLASS_HUGE
#define DEFAULT_VOLUME_GIGANTIC WEIGHT_CLASS_GIGANTIC
...
/// Basically how many of volume THING can fit in it
#define AUTO_SCALE_STORAGE_VOLUME(max_w_class, max_items) (AUTO_SCALE_VOLUME(max_w_class) * max_items)
...
#define STORAGE_VOLUME_CHEMISTRY_BAG (DEFAULT_VOLUME_TINY * 14)
