...
#define isrobotic(A) (is_species(A, /datum/species/synthfurry/ipc) || is_species(A, /datum/species/synthfurry) || is_species(A, /datum/species/adapted) || is_species(/datum/species/synth) || is_species(/datum/species/android) || is_species(/datum/species/mammal/synthetic/endoskeleton))
