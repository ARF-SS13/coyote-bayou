...
#define INTERACT_ITEM_ATTACK_HAND_IS_ALT 	(1<<1)		//attempt altclicking on it when clicked (can only be opened, for the most part)
#define INTERACT_ITEM_ATTACK_HAND_IS_SHIFT 	(1<<2)		//attempt shiftclicking on it when clicked (can only be examined, for the most part)
