...
#define SHIELD_FLAGS_HEAVY (SHIELD_CAN_BASH | SHIELD_BASH_WALL_KNOCKDOWN | SHIELD_BASH_WALL_DISARM | SHIELD_BASH_GROUND_SLAM | SHIELD_BASH_ALWAYS_KNOCKDOWN)

#define SHIELD_FLAGS_LIGHT (SHIELD_CAN_BASH | SHIELD_BASH_GROUND_SLAM | SHIELD_BASH_ALWAYS_DISARM)
