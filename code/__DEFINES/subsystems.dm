...
#define FIRE_PRIORITY_PARALLAX		5
#define FIRE_PRIORITY_SPACEDRIFT	5
#define FIRE_PRIORITY_AIR			5
#define FIRE_PRIORITY_AIR_TURFS		5
#define FIRE_PRIORITY_ATMOS_ADJACENCY  5
...
#define FIRE_PRIORITY_GARBAGE		55
#define FIRE_PRIORITY_NPC_MOVEMENT	85
#define FIRE_PRIORITY_NPC			100
