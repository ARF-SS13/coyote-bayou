...
/mob/living/carbon/human/proc/sleeping_carp_help()
	...
	to_chat(usr, span_notice("You are highly resistant to stuns and knockdowns, and have access to new fighting moves. However, you are not invincible, and sustained damage will take it's toll. Avoid heat at all costs!"))
