...
/datum/martial_art/berserker/proc/hardPunch(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.apply_damage((damage + 1) + crit_damage, BRUTE, affecting, wound_bonus = CANT_WOUND)
	return TRUE
...
/datum/martial_art/berserker/proc/chokeSlam(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if((D.mobility_flags & MOBILITY_STAND))
		...
		D.apply_damage(damage*0.5, BRUTE, BODY_ZONE_HEAD, wound_bonus = CANT_WOUND)
		D.apply_damage(damage + 20, STAMINA, BODY_ZONE_HEAD, wound_bonus = CANT_WOUND)
