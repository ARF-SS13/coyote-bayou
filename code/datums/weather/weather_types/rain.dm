...
/datum/weather/rain/fog
	...
	telegraph_sound = 'sound/weather/fog.ogg' //credit: boomlibrary
	weather_sound = 'sound/weather/fog.ogg'

	weather_message = "<span class='notice'><i>You feel the moisture from the fog as it starts to roll in.</i></span>"
	weather_overlay = "fog"
	weather_duration_lower = 2400
	weather_duration_upper = 7200
	end_sound = 'sound/weather/fog.ogg' //credit: boomlibrary
	end_duration = 250
