...
/datum/mind/proc/add_skill_modifier(id)
	...
	if(M.modifier_flags & MODIFIER_SKILL_BODYBOUND)
		M.RegisterSignal(src, TYPE_PROC_REF(COMSIG_MIND_TRANSFER, /datum/skill_modifier,on_mind_transfer))
		M.RegisterSignal(current, TYPE_PROC_REF(COMSIG_MOB_ON_NEW_MIND, /datum/skill_modifier,on_mob_new_mind), TRUE)
...
/datum/skill_modifier/proc/on_mob_new_mind(mob/source)
	...
	RegisterSignal(source.mind, TYPE_PROC_REF(COMSIG_MIND_TRANSFER, /datum/skill_modifier,on_mind_transfer))
