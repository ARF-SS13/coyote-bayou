...
/datum/ert/New()
	if (!polldesc)
		polldesc = "a Code [code] US Government Emergency Response Team"
...
/datum/ert/deathsquad
	...
	polldesc = "an elite US Government Strike Team"
...
/datum/ert/inquisition
	...
	polldesc = "a US Government paranormal response team"
