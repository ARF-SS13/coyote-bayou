...
/obj/item/glasswork/glass_base/glass_lens
	...
	desc = "A set of glass sheets set aside for glass working. This one is ideal for a small glass lens. It needs to be cut with some glassworking tools."
...
/obj/item/glasswork/glass_base/glass_lens_part3
	...
	desc = "Cut glass that has been heated into a blob of hot glass. It needs to be attached to a glassblowing rod."
