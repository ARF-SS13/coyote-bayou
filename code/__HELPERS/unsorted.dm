...
#define VARSET_CALLBACK(datum, var, var_value) CALLBACK(GLOBAL_PROC_REF(___callbackvarset), ##datum, NAMEOF_STATIC(##datum, ##var), ##var_value)
...
#define	TRAIT_CALLBACK_ADD(target, trait, source) CALLBACK(GLOBAL_PROC_REF(___TraitAdd), ##target, ##trait, ##source)
#define	TRAIT_CALLBACK_REMOVE(target, trait, source) CALLBACK(GLOBAL_PROC_REF(___TraitRemove), ##target, ##trait, ##source)
