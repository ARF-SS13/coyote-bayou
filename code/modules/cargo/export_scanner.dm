/obj/item/export_scanner
	name = "export scanner"
	desc = "A device used to check objects against US Government exports and bounty database. Sadly can not scan reagents vaule."
...
/obj/item/export_scanner/afterattack(obj/O, mob/user, proximity)
	...
	if(istype(O, /obj/machinery/computer/cargo))
		...
		if(price)
			...
			to_chat(user, span_notice("Scanned [O], value: <b>[price]</b> credits / <b>[price / scrip_conv]</b> scrip / <b>[price / copper_conv]</b> copper [O.contents.len ? "(contents included)" : ""]."))
		else
