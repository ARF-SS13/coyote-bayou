...
/obj/structure/car
	name = "Pre-Fall rubbish"
	desc = "A rusty Pre-Fall automobile carcass.<br>This car is damaged beyond repair."
...
/obj/structure/debris/v1
	name = "Pre-Fall building debris"
	desc = "A Pre-Fall building debris."
	icon = 'icons/fallout/objects/structures/rubish.dmi'
	icon_state = "debris1"
	bound_width = 64
	bound_height = 64
