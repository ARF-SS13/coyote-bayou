/obj/item/projectile/bullet/shotgun_slug
	...
	damage = BULLET_DAMAGE_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS
	stamina = BULLET_STAMINA_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS
	spread = BULLET_SPREAD_SURPLUS

	wound_bonus = BULLET_WOUND_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS
...
/obj/item/projectile/bullet/shotgun_beanbag
	name = "beanbag slug"
	damage = BULLET_DAMAGE_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * RUBBERY_DAMAGE_MULT
	stamina = RUBBERY_STAMINA_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS
	spread = BULLET_SPREAD_SURPLUS

	wound_bonus = RUBBERY_WOUND_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS
...
/obj/item/projectile/bullet/incendiary/shotgun
	...
	damage = BULLET_DAMAGE_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_DAMAGE_FIRE
	stamina = RUBBERY_STAMINA_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_STAMINA_FIRE
	spread = BULLET_SPREAD_SURPLUS

	wound_bonus = RUBBERY_WOUND_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_WOUND_FIRE
...
/obj/item/projectile/bullet/incendiary/shotgun/dragonsbreath
	...
	damage = BULLET_DAMAGE_SHOTGUN_PELLET * BULLET_DAMAGE_SURPLUS * BULLET_DAMAGE_FIRE
	stamina = RUBBERY_STAMINA_SHOTGUN_PELLET * BULLET_DAMAGE_SURPLUS * BULLET_STAMINA_FIRE
	spread = BULLET_SPREAD_SURPLUS
	damage_type = BURN

	wound_bonus = RUBBERY_WOUND_SHOTGUN_PELLET * BULLET_DAMAGE_SURPLUS * BULLET_WOUND_FIRE
...
/obj/item/projectile/bullet/shotgun_meteorslug
	...
	icon_state = "dust"
	damage = BULLET_DAMAGE_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_METEORSLUG_DAMAGE_MULT
	stamina = BULLET_STAMINA_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_METEORSLUG_STAMINA_MULT
	spread = BULLET_SPREAD_SURPLUS

	wound_bonus = BULLET_WOUND_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_METEORSLUG_WOUND_MULT
...
/obj/item/projectile/bullet/shotgun_frag12
	name ="frag12 slug"
	damage = BULLET_DAMAGE_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_DAMAGE_EXPLOSIVE
	stamina = BULLET_STAMINA_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_STAMINA_EXPLOSIVE
	spread = BULLET_SPREAD_SURPLUS

	wound_bonus = BULLET_WOUND_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_WOUND_EXPLOSIVE
...
/obj/item/projectile/bullet/pellet/shotgun_buckshot
	...
	damage = BULLET_DAMAGE_SHOTGUN_PELLET * BULLET_DAMAGE_SURPLUS
	stamina = BULLET_STAMINA_SHOTGUN_PELLET * BULLET_DAMAGE_SURPLUS
	spread = BULLET_SPREAD_SURPLUS

	wound_bonus = BULLET_WOUND_SHOTGUN_PELLET * BULLET_DAMAGE_SURPLUS
...
/obj/item/projectile/bullet/pellet/shotgun_rubbershot
	...
	damage = BULLET_DAMAGE_SHOTGUN_PELLET * BULLET_DAMAGE_SURPLUS * RUBBERY_DAMAGE_MULT
	stamina = RUBBERY_STAMINA_SHOTGUN_PELLET * BULLET_DAMAGE_SURPLUS
	spread = BULLET_SPREAD_SURPLUS

	wound_bonus = RUBBERY_WOUND_SHOTGUN_PELLET * BULLET_DAMAGE_SURPLUS
...
/obj/item/projectile/bullet/pellet/shotgun_improvised
	damage = BULLET_DAMAGE_SHOTGUN_PELLET * BULLET_DAMAGE_HANDLOAD
	stamina = BULLET_STAMINA_SHOTGUN_PELLET * BULLET_DAMAGE_HANDLOAD
	spread = BULLET_SPREAD_HANDLOAD

	wound_bonus = BULLET_WOUND_SHOTGUN_PELLET * BULLET_DAMAGE_HANDLOAD
	bare_wound_bonus = BULLET_WOUND_SHOTGUN_PELLET * BULLET_NAKED_WOUND_MULT
	wound_falloff_tile = BULLET_WOUND_FALLOFF_SHOTGUN_PELLET
...
/obj/item/projectile/bullet/pellet/trainshot
	damage = BULLET_DAMAGE_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_TRAINSLUG_DAMAGE_MULT
	stamina = BULLET_STAMINA_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_TRAINSLUG_STAMINA_MULT
	spread = BULLET_SPREAD_SURPLUS

	wound_bonus = BULLET_WOUND_SHOTGUN_SLUG * BULLET_DAMAGE_SURPLUS * BULLET_TRAINSLUG_WOUND_MULT
