...
/obj/item/gun_upgrade/trigger/better/New()
	...
	var/datum/component/item_upgrade/I = AddComponent(/datum/component/item_upgrade)
	I.weapon_upgrades = list(
		GUN_UPGRADE_FIRE_DELAY_MULT=1 + rand(-7,-20) * 0.01
	)
	I.gun_loc_tag = GUN_TRIGGER
...
/obj/item/gun_upgrade/barrel/better/New()
	...
	var/datum/component/item_upgrade/I = AddComponent(/datum/component/item_upgrade)
	I.weapon_upgrades = list(
		GUN_UPGRADE_DAMAGE_MULT=1 + rand(12,22) * 0.01,
		GUN_UPGRADE_RECOIL_1H = 1 + rand(25,80) * 0.01,
		GUN_UPGRADE_RECOIL_2H = 1 + rand(25,60) * 0.01,
		GUN_UPGRADE_FIRE_DELAY_MULT = 1 + rand(20,30) * 0.01
		)
	I.gun_loc_tag = GUN_BARREL
	I.req_gun_tags = list(GUN_PROJECTILE)
...
/obj/item/gun_upgrade/barrel/mag_accel/New()
	...
	I.weapon_upgrades = list(
		...
		GUN_UPGRADE_FIRE_DELAY_MULT=1 + rand(20,25) * 0.01,
		GUN_UPGRADE_DAMAGE_MULT=1 + rand(10,18) * 0.01
	)
	I.gun_loc_tag = GUN_BARREL
	I.req_gun_tags = list(GUN_PROJECTILE)
...
/obj/item/gun_upgrade/mechanism/overdrive/New()
	...
	I.weapon_upgrades = list(
		...
		GUN_UPGRADE_CHARGECOST=1 + rand(-40,-30) * 0.01
	)
	I.req_fuel_cell = REQ_CELL
	I.gun_loc_tag = GUN_MECHANISM
