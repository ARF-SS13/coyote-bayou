...
/datum/ai_controller/proc/PossessPawn(atom/new_pawn)
	...
	RegisterSignal(pawn, COMSIG_MOB_CLIENT_LOGIN, .proc/on_sentience_gained)
...
/datum/ai_controller/proc/UnpossessPawn(destroy)
	UnregisterSignal(pawn, list(COMSIG_MOB_CLIENT_LOGIN, COMSIG_MOB_CLIENT_LOGOUT))
...
/datum/ai_controller/proc/on_sentience_gained()
	...
	RegisterSignal(pawn, COMSIG_MOB_CLIENT_LOGOUT, .proc/on_sentience_lost)
