...
/datum/design/triphasic_scanning
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 200, /datum/material/glass = 200, /datum/material/diamond = 30, /datum/material/prewarpolymer = 30)
...
/datum/design/bluespace_matter_bin
	...
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 250, /datum/material/diamond = 100, /datum/material/prewarpolymer = 100)
