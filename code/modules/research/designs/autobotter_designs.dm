...
/datum/design/bottle/export/vodka
	...
	id = "vodka_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/vodka = 100)
...
/datum/design/bottle/export/tequila
	...
	id = "tequila_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/tequila = 100)
...
/datum/design/bottle/export/sake
	...
	id = "sake_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/sake = 100)
...
/datum/design/bottle/export/hcider
	...
	id = "hcider_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/hcider = 100)
...
/datum/design/bottle/export/applejack
	...
	id = "applejack_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/applejack = 100)
...
/datum/design/bottle/export/champagne
	...
	id = "champagne_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/champagne = 100)
...
/datum/design/bottle/export/blazaam
	...
	id = "blazaam_export"
	reagents_list = list(/datum/reagent/consumable/ethanol/blazaam = 100)
