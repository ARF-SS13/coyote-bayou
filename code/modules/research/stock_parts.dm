...
/obj/item/stock_parts/capacitor
	name = "capacitor </font><br><font color='red'>(T1).</font>"
	desc = "A pre-war design for a simple consumer-grade CAPACITOR. Not much better than a watch battery."
	icon_state = "capacitor"
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=50)

/obj/item/stock_parts/scanning_module
	name = "scanning module </font><br><font color='red'>(T1).</font>"
	desc = "A pre-war design for a simple consumer-grade SCANNING MODULE. Not much better than a light sensitive circuit."
	icon_state = "scan_module"
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=20)

/obj/item/stock_parts/manipulator
	name = "manipulator </font><br><font color='red'>(T1).</font>"
...
/obj/item/stock_parts/micro_laser
	name = "laser </font><br><font color='red'>(T1).</font>"
	desc = "A pre-war design for a simple consumer-grade LASER. Not much better than a nixie tube."
	icon_state = "micro_laser"
	custom_materials = list(/datum/material/iron=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin
	name = "matter bin </font><br><font color='red'>(T1).</font>"
	desc = "A pre-war design for a simple consumer-grade MATTER BIN. Not much better than a funnel."
...
/obj/item/stock_parts/capacitor/simple
	name = "watch battery </font><br><font color='orange'>(T2).</font>"
...
/obj/item/stock_parts/scanning_module/simple
	name = "light sensitive circuit </font><br><font color='orange'>(T2).</font>"
	desc = "Sometimes found in cameras or infrared detectors. Useful as a SCANNING MODULE, if a little low-tech."
	icon_state = "light_sensitive_circuit"
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=20)

/obj/item/stock_parts/manipulator/simple
	name = "simple gear </font><br><font color='orange'>(T2).</font>"
	desc = "A simple gear. A couple of these could probably be used in a mechanism as a MANIPULATOR."
	icon_state = "simple_gear"
	custom_materials = list(/datum/material/iron=30)

/obj/item/stock_parts/micro_laser/simple
	name = "nixie tube </font><br><font color='orange'>(T2).</font>"
	desc = "A small bulb with a complicated filament pattern. Puts off enough heat that it could be used for heating small components in a pinch. Like a LASER."
	icon_state = "simple_bulb"
	custom_materials = list(/datum/material/iron=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin/simple
	name = "intake funnel </font><br><font color='orange'>(T2).</font>"
	desc = "Practically a metal cone. Useful to store some stuff in a machine, at least. It's a MATTER BIN of sorts."
	icon_state = "funnel"
	custom_materials = list(/datum/material/iron=80)
...
/obj/item/stock_parts/capacitor/adv
	name = "upgraded capacitor </font><br><font color='yellow'>(T3).</font>"
...
/obj/item/stock_parts/scanning_module/adv
	name = "small antenna </font><br><font color='yellow'>(T3).</font>"
	desc = "Useful as a SCANNING MODULE and for analyzing signals. Comes with a built in miniature light sensor, too!"
	icon_state = "small_antenna"
	rating = 2
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=20)

/obj/item/stock_parts/manipulator/nano
	name = "complex gearwork </font><br><font color='yellow'>(T3).</font>"
	desc = "More than a few gears interlocked together, useful as a MANIPULATOR in machinery."
	icon_state = "complex_gearwork"
	rating = 2
	custom_materials = list(/datum/material/iron=30)

/obj/item/stock_parts/micro_laser/high
	name = "flash bulb </font><br><font color='yellow'>(T3).</font>"
	desc = "A reusable flash bulb. Not only does it shine particularly bright, it can let out a fair bit of heat like a LASER in machinery."
	icon_state = "modern_bulb"
	rating = 2
	custom_materials = list(/datum/material/iron=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin/adv
	name = "hopper </font><br><font color='yellow'>(T3).</font>"
	desc = "A spacious hopper for containing just about anything in a machine and distributing it effectively. It's a MATTER BIN, really."
	icon_state = "hopper"
	rating = 2
	custom_materials = list(/datum/material/iron=80)
...
/obj/item/stock_parts/capacitor/super
	name = "advanced capacitor </font><br><font color='green'>(T4).</font>"
...
/obj/item/stock_parts/scanning_module/phasic
	name = "advanced antenna </font><br><font color='green'>(T4).</font>"
	desc = "A high-resolution antenna and camera device, this could be used as a SCANNING MODULE in a pretty wide variety of things."
	icon_state = "advanced_antenna"
	rating = 3
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=20)

/obj/item/stock_parts/manipulator/pico
	name = "delicate mechanism </font><br><font color='green'>(T4).</font>"
	desc = "A whole lot of finely crafted gears, belts, and gearshafts. This could probably be used as a MANIPULATOR in machinery with microscopic precision."
	icon_state = "delicate_mechanism"
	rating = 3
	custom_materials = list(/datum/material/iron=30)

/obj/item/stock_parts/micro_laser/ultra
	name = "laser diode </font><br><font color='green'>(T4).</font>"
	icon_state = "diode"
	desc = "A LASER diode able to put out heat and light very precisely in machinery."
	rating = 3
	custom_materials = list(/datum/material/iron=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin/super
	name = "storage bin </font><br><font color='green'>(T4).</font>"
	desc = "A small container designed compressed and store just about anything safely in a machine as a MATTER BIN."
...
/obj/item/stock_parts/capacitor/quadratic
	name = "pre-war hyper capacitor </font><br><font color='purple'>(T5).</font>"
...
/obj/item/stock_parts/scanning_module/triphasic
	name = "pre-war 64k scanning device </font><br><font color='purple'>(T5).</font>"
	desc = "A compact, ultra-high resolution SCANNING MODULE made with pre-war materials and designs."
	icon_state = "pre_war_scanner"
	rating = 4
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=20)

/obj/item/stock_parts/manipulator/femto
	name = "pre-war ultra servo </font><br><font color='purple'>(T5).</font>"
	desc = "A microservo capable of filling the role of a MANIPULATOR in machinery on the atomic scale, made using pre-war materials and designs."
	icon_state = "pre_war_servo"
	rating = 4
	custom_materials = list(/datum/material/iron=30)

/obj/item/stock_parts/micro_laser/quadultra
	name = "pre-war hyper laser emitter </font><br><font color='purple'>(T5).</font>"
	icon_state = "pre_war_emitter"
	desc = "This extremely powerful LASER array could only be made with pre-war materials and designs."
	rating = 4
	custom_materials = list(/datum/material/iron=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin/bluespace
	name = "pre-war maximum storage system </font><br><font color='purple'>(T5).</font>"
	desc = "A MATTER BIN that uses the same pre-war tech that some military equipment used to contain large amounts of material."
