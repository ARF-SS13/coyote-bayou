...
/obj/item/paper/fluff/ruins/clericsden/contact
	info = "Father Aurellion, the ritual is complete, and soon our brothers at the bastion will see the error of our ways. After all, a monster of clockwork or blood? Preposterous. Only the TRUTH should have so much power. Signed, Father Odivallus."
