...
/obj/item/paper/fluff/ruins/listeningstation/reports/april
	name = "april report"
	info = "A good start to the operation: intercepted US Government military communications. A convoy is scheduled to transfer nuclear warheads to a new military base. This is as good a chance as any to get our hands on some heavy weaponry, I suggest we take it."
...
/obj/item/paper/fluff/ruins/listeningstation/briefing
	...
	info = "<b>Mission Details</b>: You have been assigned to a newly constructed listening post constructed within an asteroid in US Government space to monitor their plasma mining operations. Accurate intel is crucial to the success of our operatives onboard, do not fail us."
