...
/obj/machinery/mineral/wasteland_vendor/ammo
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment(".357 BP Box (60 Bullets)",						/obj/item/ammo_box/b357,						270),
		new /datum/data/wasteland_equipment(".44 BP Box (60 Bullets)",						/obj/item/ammo_box/b44,							270),
		new /datum/data/wasteland_equipment(".45 BP Box (60 Bullets)",						/obj/item/ammo_box/b45,							270),
		new /datum/data/wasteland_equipment("5.56 SL Box (50 Bullets)",						/obj/item/ammo_box/s556,						330),
		new /datum/data/wasteland_equipment("7.62x39 SL Box (40 Bullets)",					/obj/item/ammo_box/s762by39,					330),
		new /datum/data/wasteland_equipment(".308 SL Box (30 Bullets)",						/obj/item/ammo_box/s308,						400),
		new /datum/data/wasteland_equipment(".30-06 SL Box (20 Bullets)",					/obj/item/ammo_box/s3006,						400),
		new /datum/data/wasteland_equipment("Buckshot BP Box (20 Bullets)",					/obj/item/ammo_box/bbuckshot,					275),
		new /datum/data/wasteland_equipment("Field Arrow (1 arrow)",						/obj/item/ammo_casing/caseless/arrow/field,		1),
