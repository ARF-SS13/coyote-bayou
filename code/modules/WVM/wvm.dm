...
/obj/machinery/mineral/wasteland_vendor/traderspecial
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Black Bronze x1",					/obj/item/ingot/bronze,								50), // you can literally print this shit en masse with cable coils and sheets
		new /datum/data/wasteland_equipment("Rose Steel x1",					/obj/item/ingot/mythril,							100),
		new /datum/data/wasteland_equipment("Ultrasteel x1",					/obj/item/ingot/adamantine,							200),
