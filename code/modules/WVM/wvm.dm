...
/obj/machinery/mineral/wasteland_vendor/weapons
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Sig P220 (.45)",				/obj/item/gun/ballistic/automatic/pistol/sig,						100),
		new /datum/data/wasteland_equipment("Automag (.44)",			/obj/item/gun/ballistic/automatic/pistol/automag,						100),
		new /datum/data/wasteland_equipment("M1A1 Carbine (10mm)",			/obj/item/gun/ballistic/automatic/m1carbine/compact,				100),
		new /datum/data/wasteland_equipment("Lee Enfield (.308)",				/obj/item/gun/ballistic/rifle/enfield,							100),
		new /datum/data/wasteland_equipment("Remington 700 (.30-06)",				/obj/item/gun/ballistic/rifle/hunting/remington,			100),
		new /datum/data/wasteland_equipment("Trench Shotgun (12 gauge)",		/obj/item/gun/ballistic/shotgun/trench,							100),
		new /datum/data/wasteland_equipment("Surplus Nash Police Rifle (5.56)",		/obj/item/gun/ballistic/automatic/marksman/policerifle,		100),
		new /datum/data/wasteland_equipment("Surplus Nash Auto Rifle (5mm)",	/obj/item/gun/ballistic/automatic/assault_carbine/policerifle,	150),
		new /datum/data/wasteland_equipment("Compliance Regulator (SEC)",	/obj/item/gun/energy/laser/complianceregulator,						150),
		new /datum/data/wasteland_equipment("AEP-7 (SEC)",					/obj/item/gun/energy/laser/pistol,									150),
		new /datum/data/wasteland_equipment("Compact RCW (ECP)",			/obj/item/gun/energy/laser/auto,									150),
		new /datum/data/wasteland_equipment("AER-9 (MFC)",					/obj/item/gun/energy/laser/aer9,									150),
