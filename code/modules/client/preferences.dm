...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_tab)
		...
		if(CONTENT_PREFERENCES_TAB)
			...
			dat += "<b>Being Prey:</b> <a href='?_src_=prefs;preference=allow_prey'>[(allow_being_prey) ? "Allowed" : "Disallowed"]</a><br>"
			dat += "<b>Being Fed Prey:</b> <a href='?_src_=prefs;preference=allow_fed_prey'>[(allow_being_fed_prey) ? "Allowed" : "Disallowed"]</a><br>"
			dat += "<b>Digestion Damage:</b> <a href='?_src_=prefs;preference=allow_digest_damage'>[(allow_digestion_damage) ? "Allowed" : "Disallowed"]</a><br>"
			dat += "<b>Digestion Death:</b> <a href='?_src_=prefs;preference=allow_digest_death'>[(allow_digestion_death) ? "Allowed" : "Disallowed"]</a><br>"
			dat += "<b>Vore Messages:</b> <a href='?_src_=prefs;preference=allow_vore_text'>[(allow_vore_messages) ? "Visible" : "Hidden"]</a><br>"
			dat += "<b>Vore Death Messages:</b> <a href='?_src_=prefs;preference=allow_vore_death_text'>[(allow_death_messages) ? "Visible" : "Hidden"]</a><br>"
			dat += "<b>Vore Eating Sounds:</b> <a href='?_src_=prefs;preference=allow_eat_sounds'>[(allow_eating_sounds) ? "Audible" : "Muted"]</a><br>"
