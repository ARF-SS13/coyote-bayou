...
/mob/living/simple_animal/drone/ComponentInitialize()
	...
	if(can_be_held)
		...
		AddElement(/datum/element/mob_holder, TYPE_PROC_REF(null, 'icons/mob/clothing/head.dmi', 'icons/mob/inhands/clothing_righthand.dmi', 'icons/mob/inhands/clothing_lefthand.dmi', INV_SLOTBIT_HEAD, /datum/element/mob_holder,drone_worn_icon))
