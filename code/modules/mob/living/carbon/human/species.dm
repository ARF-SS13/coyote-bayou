...
/datum/species
	...
	var/punchdamagehigh = 8      //highest possible punch damage
	var/punchstunthreshold = 8//damage at which punches from this race will stun //yes it should be to the attacked race but it's not useful that way even if it's logical
