/mob/living/carbon/monkey
	...
	guaranteed_butcher_results = list(/obj/item/reagent_containers/food/snacks/meat/slab/monkey = 5, /obj/item/stack/sheet/animalhide/monkey = 1)
...
/mob/living/carbon/monkey/ComponentInitialize()
	. = ..()
	AddElement(/datum/element/mob_holder, worn_state = "monkey", inv_slots = INV_SLOTBIT_HEAD)
