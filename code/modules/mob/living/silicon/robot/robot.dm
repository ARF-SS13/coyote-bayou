...
/mob/living/silicon/robot/modules/syndicate/saboteur
	...
	playstyle_string = "<span class='big bold'>You are a Syndicate saboteur cyborg!</span><br>\
						...
						Your cyborg chameleon projector allows you to assume the appearance and registered name of a US Government engineering borg, and undertake covert actions on the station \
