...
/obj/item/clothing/head/hardhat/ncr
	...
	inhand_icon_state = "hardhat0_ncr"
	item_color = "ncr"
	hat_type = "ncr"
	flags_inv = HIDEEARS
	dog_fashion = null
...
/obj/item/clothing/head/helmet/f13/khan/pelt
	...
	inhand_icon_state = "khan_helmetpelt"
...
/obj/item/clothing/head/helmet/f13/khan/bandana
	...
	inhand_icon_state = "khan_bandana"
	strip_delay = 10
...
/obj/item/clothing/head/helmet/f13/khan/fullhelm
	...
	inhand_icon_state = "khan_fullhelmet"
...
/obj/item/clothing/head/helmet/infiltrator/contractor/CtrlShiftClick(mob/user)
	...
	switch(choice)
		...
		if("Orange Stripe")
			...
			inhand_icon_state = "syndicate-helm-black-orange"
		if("Blue Stripe")
			balloon_alert(user, "Your suit changes color.")
		...
		if("Medic Marks")
			...
			inhand_icon_state = "syndicate-helm-black-med"
		if("Engi Marks")
			balloon_alert(user, "Your suit changes color.")
			icon_state = "syndicate-helm-black-engie"
			inhand_icon_state = "syndicate-helm-black-engie"
		if("Contractor")
			balloon_alert(user, "Your suit changes color.")
			icon_state = "syndicate-contract-helm"
			inhand_icon_state = "syndicate-contract-helm"
...
/obj/item/clothing/head/f13/army/beret/airborne
	...
	inhand_icon_state = "army_beret_airborne"
...
/obj/item/clothing/head/f13/army/beret/rangers
	...
	inhand_icon_state = "army_beret_ranger"
...
/obj/item/clothing/head/f13/army/beret/specialforces
	...
	inhand_icon_state = "army_beret_specialforces"
...
/obj/item/clothing/head/f13/police/sergeant
	...
	inhand_icon_state = "police_sergeant"
...
/obj/item/clothing/head/helmet/f13/combat/mk2/ncr
	...
	inhand_icon_state = "ncr_helmet_mk2"
