...
#define ARMOR_AVERSION_THRESHOLD_MELEE 	20
#define ARMOR_AVERSION_THRESHOLD_BULLET 5
#define ARMOR_AVERSION_THRESHOLD_LASER 	10
#define ARMOR_AVERSION_THRESHOLD_THRES	0
