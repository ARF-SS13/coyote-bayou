...
/obj/item/survivalcapsule
	...
	desc = "A basic C.A.M.P. packed tight.  Shake it and throw it!"
	icon_state = "capsule"
...
/obj/item/survivalcapsule/premium
	name = "Messhall C.A.M.P."
	desc = "A small mess hall C.A.M.P.  Shake it and throw it!"
	template_id = "shelter_beta"

/obj/item/survivalcapsule/quad
	name = "Spacious C.A.M.P."
	desc = "An expanded C.A.M.P. with two living quarters.  Shake it and throw it!"
	template_id = "shelter_charlie"

/obj/item/survivalcapsule/merchant
	name = "Merchant C.A.M.P."
	desc = "A partially covered merchants C.A.M.P.  Shake it and throw it!"
	template_id = "shelter_delta"

/obj/item/survivalcapsule/party
	name = "Party C.A.M.P."
	desc = "A large, spacious C.A.M.P. for parties.  Shake it and throw it!"
	template_id = "shelter_echo"

/obj/item/survivalcapsule/kitchen
	name = "Cook-N-Go C.A.M.P."
	desc = "A rapid, ready to deploy field mess kitchen. C.A.M.P. Shake it and throw it!"
	template_id = "shelter_foxtrot"

/obj/item/survivalcapsule/farm
	name = "Farm-N-Go C.A.M.P."
	desc = "A ready to go, loaded farming plot C.A.M.P. Shake it and throw it!"
	template_id = "shelter_golf"

/obj/item/survivalcapsule/brahmin
	name = "Brahmin breeder C.A.M.P."
	desc = "A C.A.M.P. for three brahmin and all their needs, yours not included. Shake it and throw it!"
	template_id = "shelter_hotel"

/obj/item/survivalcapsule/threeman
	name = "Threeman C.A.M.P."
	desc = "A C.A.M.P. suitable for three... not comfortably.  Shake it and throw it!"
	template_id = "shelter_india"

/obj/item/survivalcapsule/forge
	name = "Forgemaster C.A.M.P."
	desc = "The start to something great on your forging journey.  Shake it and throw it!"
	template_id = "shelter_juliett"

/obj/item/survivalcapsule/medicineman
	name = "Medicineman C.A.M.P."
	desc = "The start to something great on your shamanistic journey. Shake it and throw it!"
	template_id = "shelter_kilo"
