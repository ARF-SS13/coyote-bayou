...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Nuka X-Treme",				/obj/item/reagent_containers/food/drinks/drinkingglass/filled/nukaxtreme,			100),
		new /datum/data/mining_equipment("Nukacide",					/obj/item/reagent_containers/food/drinks/drinkingglass/filled/nukacide,	100),
...
//		new /datum/data/mining_equipment("Explorer's Webbing",			/obj/item/storage/belt/utility/mining,										500),
		...
		new /datum/data/mining_equipment("Medicated Suture", 			/obj/item/stack/medical/suture/medicated,							2000),
