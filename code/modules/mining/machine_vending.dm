...
//		new /datum/data/mining_equipment("Explorer's Webbing",			/obj/item/storage/belt/utility/mining,										500),
		...
		new /datum/data/mining_equipment("Ore Bag of Holding",			/obj/item/storage/bag/ore/holding,									1000),
		new /datum/data/mining_equipment("Medicated Sutures", 			/obj/item/stack/medical/suture/medicated,							250),
		new /datum/data/mining_equipment("Advanced Mesh", 				/obj/item/stack/medical/mesh/advanced,								250),
		new /datum/data/mining_equipment("Sterile Bandages", 			/obj/item/stack/medical/gauze/adv,									250),
...
//		new /datum/data/mining_equipment("Kinetic Accelerator",			/obj/item/gun/energy/kinetic_accelerator,							750),
		new /datum/data/mining_equipment("Survival Medipen",			/obj/item/reagent_containers/hypospray/medipen/survival,			100),
		new /datum/data/mining_equipment("Brute First-Aid Kit",			/obj/item/storage/firstaid/brute,									500),
		new /datum/data/mining_equipment("Burn First-Aid Kit",			/obj/item/storage/firstaid/fire,									500),
		new /datum/data/mining_equipment("First-Aid Kit",				/obj/item/storage/firstaid/ancient,									750),
