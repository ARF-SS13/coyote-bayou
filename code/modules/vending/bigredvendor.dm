/obj/machinery/vending/bigredvend
	name = "\improper Big Red vending machine"
	desc = "A still-working Big Red vending machine! Full of that Big Red taste!"
	icon = 'icons/obj/f13vending.dmi'
	icon_state = "bigred_vending"
	icon_deny = "bigred_vending"
	product_slogans = "Take a ride on a Big Red!"
	products = list(
...
/obj/item/vending_refill/bigredvend
	machine_name = "Big Red vending machine"
