...
/datum/surgery_step/cut_fat
	name = "cut excess fat"
	implements = list(TOOL_SAW = 100, /obj/item/hatchet = 35, /obj/item/melee/onehanded/knife/butcher = 25) //why we need a saw to cut adipose tissue is beyond me, shit's soft as fuck
	time = 64
