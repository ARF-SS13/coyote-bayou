...
/obj/item/reagent_containers/food/snacks/brownie_sheet_peanut
	...
	slices_num = 4
	list_reagents = list(/datum/reagent/consumable/nutriment = 20, /datum/reagent/consumable/sugar = 12, /obj/item/reagent_containers/food/condiment/peanut_butter  = 20)
	tastes = list("brownie" = 1, "chocolatey goodness" = 1)
	foodtype = GRAIN | JUNKFOOD | SUGAR
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/reagent_containers/food/snacks/brownie/peanut
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/sugar = 3, /obj/item/reagent_containers/food/condiment/peanut_butter  = 5)
