				...
				if(ishuman(L))//are they a carbon?
					...
					if(prob(35)) //checking if the delay is over & if the victim actually has any parts to nom
						...
						if(plasma_parts.len)
							...
							PP.emote("scream")
							NB.species_id = SPECIES_PLASMAMAN//change the species_id of the limb to that of a plasmaman
							NB.no_update = TRUE
...
/obj/item/paper/crumpled/ruins/snowdin/misc1
	...
	info = {"Holy shit, what a rush! Those US Government bastards didn't even know what hit 'em! All five of us dropped in right on the captain, didn't even have time to yell! We were in and out with that disk in mere minutes!
...
/obj/item/paper/fluff/awaymissions/snowdin/profile/sec1
	...
	info = {"<b><center>Personnel Log</b></center><br><br><b>Name:</b>James Reed<br><b>Age:</b>43<br><b>Gender:</b>Male<br><b>On-Site Profession:</b>Outpost Security<br><br><center><b>Information</b></center><br><center>James Reed has been a part
		...
		when it comes to keeping the peace while prioritizing US Government privacy matters. "}
...
/obj/item/paper/fluff/awaymissions/snowdin/secnotice
	...
	info = {"YOu have been assigned to this Arctic Post with intention of protecting US Government assets and ensuring vital information is kept secure while the stationed crew obeys protocol. The picked
...
//	preset_image_type = /datum/preset_holoimage/researcher
	...
	DELAY 10
	SAY Nah. I've been feeding the AI the results for the past 2 weeks to sift through the garbage and haven't seen anything out of the usual, at least whatever US Government is looking for.
	DELAY 45
	NAME Jacob Ullman
	DELAY 10
	SAY Figured as much. Dunno what US Government expects to find out here past the plasma. At least we're getting paid to fuck around for a couple months while the AI does the hard work.
	DELAY 45
	NAME Elizabeth Queef
	DELAY 10
	SAY . . .
	...
	NAME Caleb Reed
	DELAY 10
	SAY Paid in experience! That's the US Government Motto!
	DELAY 30;"}
...
/obj/item/disk/holodisk/snowdin/welcometodie
	...
	DELAY 30
	SAY US Government is pleased to have you working in one of the many top-of-the-line research posts within the $%@!! sector!
	DELAY 30
