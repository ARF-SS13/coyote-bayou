...
/obj/item/paper/pamphlet/gateway
	info = "<b>Welcome to the US Government Gateway project...</b><br>\
			...
			winning dental plan- but that's not all the US Government Gateway project has to offer.<br>\
			<br>Because we care about you, we feel it is only fair to make sure you know the risks \
			before you commit to joining the US Government Gateway project. All away destinations have \
			been fully scanned by a US Government expeditionary team, and are certified to be 100% safe. \
			...
			All US Government approved Gateways operate on the same basic principals. They operate off \
			...
			As a participant in the US Government Gateway Project, you will be on the frontiers of space. \
