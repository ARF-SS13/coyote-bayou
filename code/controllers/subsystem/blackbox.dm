...
/datum/controller/subsystem/blackbox/proc/ReportDeath(mob/living/L)
	...
	"}, list(
		...
		"key" = sanitizeSQL(L.ckey),
		"job" = sanitizeSQL(L.mind.assigned_role),
		"special" = sanitizeSQL(L.mind.special_role),
		"pod" = sanitizeSQL(get_area_name(L, TRUE)),
		"laname" = sanitizeSQL(L.lastattacker),
		"lakey" = sanitizeSQL(L.lastattackerckey),
		...
		"suicide" = L.suiciding,
		"map" = sanitizeSQL(SSmapping.config.map_name),
