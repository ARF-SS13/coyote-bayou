...
SUBSYSTEM_DEF(research)
	...
	/obj/item/blueprint/research                   = list(TECHWEB_POINT_TYPE_GENERIC = 25000),	
	...
	//----------------------------------------------
	var/list/single_server_income = list(TECHWEB_POINT_TYPE_GENERIC = 0)	//citadel edit - techwebs nerf
